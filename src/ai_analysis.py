...
class AIAnalyzer:
    ...
    def analyze_failures(self, failures: List[Dict[str, Any]], 
                        metadata: Dict[str, Any]) -> Optional[AIAnalysisResult]:
        """
...
Be concise but thorough. Provide practical, actionable advice."""
    ...
    def _create_analysis_prompt(self, failures: List[Dict[str, Any]], 
        ...
        try:
            ...
            if response_text.strip().startswith('{'):
                ...
                return AIAnalysisResult(
                    ...
                    root_cause_analysis=data.get('root_cause_analysis', 'No specific root cause identified'),
...
def analyze_failures_with_ai(failures: List[Dict[str, Any]], 
                           metadata: Dict[str, Any],
                           enabled: bool = True) -> Optional[AIAnalysisResult]:
    """
